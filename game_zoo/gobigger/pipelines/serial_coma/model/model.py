...
class Model(nn.Module):
    ...
    def compute_value(self, obs, actions, t=None):
        ...
        embedding = self.encoder(obs)
        value = self.value_head(embedding, actions, obs['value_info'], t=t)
        return value.view(B, max_t, player_num, -1)
    ...
    def rl_forward(self, obs):
        ...
        return logit.view(B, max_t, player_num, -1)
    ...
    def rl_train(self, inputs: dict, **kwargs) -> Dict[str, Any]:
        ...
        values = self.value_head(critic_input, inputs['action'])
