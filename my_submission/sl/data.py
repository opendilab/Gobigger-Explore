...
class SLDataLoader:
    ...
    def default_config():
        cfg = dict(
            ...
            batch_size=2,
            cache_size=4,
            train_data_prefix='/mnt/lustre/zhangming/workspace/software/gobigger-zoo/replays',
            train_data_file='/mnt/lustre/zhangming/workspace/software/gobigger-zoo/replays.txt.train',
            worker_num=2,
            angle_split_num=4,
            action_type_num=4,
            specific_agent_name='',
