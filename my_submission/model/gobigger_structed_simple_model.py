...
class StructedGcnConvSimple(nn.Module):
    ...
    def __init__(
        ...
        super(StructedGcnConvSimple, self).__init__()
        # scalar encoder
...
class GoBiggerHybridActionSimple(nn.Module):
    r"""
    Overview:
    ...
    def __init__(
        ...
        super(GoBiggerHybridActionSimple, self).__init__()
        self.activation = activation
        self.action_type_shape = action_type_shape
        # encoder
        self.encoder = StructedGcnConvSimple(scalar_shape, food_shape, food_relation_shape, thorn_relation_shape, clone_shape, clone_relation_shape, hidden_shape, encode_shape, activation)
        # head
